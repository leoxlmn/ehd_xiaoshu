...
namespace Google.Apis.Samples.Helper {
    ...
    public static class AuthorizationMgr {
        ...
        /// <summary>
        /// Remove the fresh token from the computer. So the user will have to logon again.
        /// </summary>
        /// <param name="storageName"></param>
        /// <param name="key"></param>
        public static void ClearRefreshToken(string storageName) {
            string file = AppData.GetFilePath(storageName + ".auth");
            if (File.Exists(file)) {
                File.Delete(file);
            }
        }
