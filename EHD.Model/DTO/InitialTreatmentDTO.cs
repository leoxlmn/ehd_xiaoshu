...
namespace EHD.Model.DTO {
    public class InitialTreatmentDTO : IComparable {
        ...
        public IList<FollowupTreatmentDTO> Followups { get; set; }

        public override string ToString() {
            return string.Format("{0} - {1} - {2}", TreatmentType, TreatmentTime, Duration);
        }
        ...
        public override bool Equals(object obj) {
            var that = obj as InitialTreatmentDTO;
        ...
        public static bool operator ==(InitialTreatmentDTO lhs, InitialTreatmentDTO rhs) {
        ...
        int IComparable.CompareTo(object obj) {
            ...
            return TreatmentTime.CompareTo((obj as InitialTreatmentDTO).TreatmentTime);
        }
    }
}
