...
namespace EHD.Model.Entity {
    [Serializable]
    public class AcupunctureFollowUpDetail : EntityBase, IComparable<AcupunctureFollowUpDetail>, IFollowUpDetail {
        ...
        public virtual int CompareTo(AcupunctureFollowUpDetail other) {
