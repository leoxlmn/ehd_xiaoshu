...
namespace EHD.Model.Entity {
    [Serializable]
    public class OsteopathyDetail : EntityBase, IComparable<OsteopathyDetail>, ITreatmentDetail {

        public virtual InitialTreatment InitialTreatment { get; set; }
        public virtual Diagram OsteopathyDiagram { get; set; }
        ...
        public virtual int CompareTo(OsteopathyDetail other) {
